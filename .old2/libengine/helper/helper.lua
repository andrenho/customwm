...
local function find_property(property)
    local cur = theme
...
function get_property(property, ...)
    local cur = find_property(property)
...
function call_property(property, ...)
    local f = find_property(property)
    if type(f) ~= "function" then error("Expected function for property " .. property .. ".") end
    f(...)
end

function call_property_opt(property, ...)
    local f = find_property(property, ...)
    if f ~= nil then
        if type(f) ~= "function" then error("Expected function for property " .. property .. ".") end
        f(...)
