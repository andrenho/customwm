...
CPPFLAGS_X11 = $(shell pkg-config --cflags x11 xft cairo pango pangocairo) -DBACKEND=X11
CXXFLAGS = -std=c++20
...
LDFLAGS_X11 = ${LDFLAGS} $(shell pkg-config --libs x11 xft cairo pango pangocairo)
